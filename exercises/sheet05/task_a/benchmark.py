...
def main():
    ...
    for optimization in optimizations:
        ...
        os.mkdir(builddir)
        build_command = 'cmake .. -G Ninja -DCMAKE_BUILD_TYPE=Release -DCMAKE_C_FLAGS_RELEASE="{optim}" -DCMAKE_CXX_FLAGS_RELEASE="{optim}" && ninja'.format(optim=optimization, builddir=builddir)
